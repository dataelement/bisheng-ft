...
def change_model_name(job_id: str = Body(), old_model_name: str = Body(),
                      model_name: str = Body()):
...
def get_job_log(job_id: str = Body()):
    ...
    return {"status_code": 200, "status_message": "success", "data": {"log_data": log}}
...
def get_job_report(job_id: str = Body()):
    ...
    return {"status_code": 200, "status_message": "success", "data": {"report": metrics}}
...
def common_sft_req(payload: dict):
    ...
    if payload['uri'] == '/v2.1/sft/job':
        ...
        return change_model_name(payload['job_id'], payload['old_model_name'],
                                 payload['model_name'])
